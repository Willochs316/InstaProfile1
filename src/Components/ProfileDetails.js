    ...
    <div className="profile-container">
      ...
      <div className="profile">
        <div className="profile-details">
          <div className="title">
            <ProfileTxt className="profile-header" text="caique silva" />
            <img
              className="verified"
          ...
          <div className="button-container">
            ...
            <div className="profile-button">
              <ProfileIcons className="fa-user-check" icon={FaUserCheck} />
            </div>

            <div className="profile-button">
              <ProfileIcons className="fa-chevron-down" icon={FaChevronDown} />
            </div>
          </div>

          <div className="ellipsis-h">
            <ProfileIcons className="fa-ellipsis-h" icon={FaEllipsisH} />
          </div>
        </div>

        <div className="profile-statistics">
          <div className="stats-container">
            <ProfileTxt className="stats" entitle="165" />
            <ProfileTxt className="profile-text" entitle="posts" />
          </div>

          <div className="stats-container">
            <ProfileTxt className="stats" entitle="40.8k" />
            <ProfileTxt className="profile-text" entitle="followers" />
          </div>

          <div className="stats-container">
            <ProfileTxt className="stats" entitle="552" />
            <ProfileTxt className="profile-text" entitle="following" />
          </div>
        </div>
        ...
        <div className="profile-bio-container">
          <div className="profile-name-conatainer">
            <ProfileTxt
              ...
              title="caique | Cinematic Storyteller"
            />
          </div>
          ...
          <div className="profile-bio">
            ...
            <div className="profile-title">
              <ProfileTxt entitle="💍 Wife To @caiquebrown_ 🇳🇬 " />
            </div>
          </div>
